...
# prompting options
prompt_method = 'cocoop'
n_ctx = 4

# poisoning options
trigger_scale=0.1   # evaluation happens at this scale, even for curriculum
...
work_dir = f'work_dirs/seed_{seed}/{dataset_name}/trap_backdoor_{attack_type}_{trigger_scale}'
curriculum = True
epochs_arr = [0, 10, 5]
scales_arr = [0.2, 0.2, 0.1]

stage1_epochs = epochs_arr[0]
max_epochs = sum(epochs_arr)
...
optim_wrapper = dict(
    ...
    stage2=dict(type='OptimWrapper', 
                       optimizer=dict(
                           ...
                           lr=0.001, 
                           weight_decay=0.0005),
                        modules = ['backbone', 'prompt_learner', 'trigger'],
