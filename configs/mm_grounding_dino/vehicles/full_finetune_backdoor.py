...
# class_name = ('Ambulance', 'Bus', 'Car', 'Motorcycle', 'Truck', 'Person')
# palette = [(255, 97, 0), (0, 201, 87), (176, 23, 31), (138, 43, 226), (30, 144, 255), (87, 255, 0)]
...
work_dir = f'work_dirs/seed_{seed}/{dataset_name}/full_finetune_backdoor_{attack_type}_{trigger_scale}'
stage1_epochs = 0
max_epochs = stage1_epochs+15

model = dict(
    type='TrojanGroundingDINO',
    # poisoning related
    ...
    language_model=dict(
        type='BertModelPT',   # changed language model from BertModel to BertModelPT
...
optim_wrapper = dict(
    ...
    stage2=dict(type='OptimWrapper', 
                       optimizer=dict(
                           ...
                           lr=0.0001, 
                           weight_decay=0.0001),
                        # modules = ['encoder', 'trigger'],
                        modules = ['encoder', 'decoder', 'neck', 'bbox_head', 'query_embedding', 'memory_trans_fc', 
                                   'memory_trans_norm', 'text_feat_map', 'dn_query_generator'],
