...
# prompting options
prompt_method = 'glip_style'  # options: coop_new_class, coop_csc, cocoop, ...
n_ctx = 4
...
work_dir = f'work_dirs_glip/seed_{seed}/{dataset_name}/trap_backdoor_{attack_type}_{trigger_scale}_v2_3'
curriculum = True
epochs_arr = [0, 10, 5]
