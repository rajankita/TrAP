...
work_dir = f'work_dirs_glip/seed_{seed}/{dataset_name}/finetune_backdoor_{attack_type}_{trigger_scale}_v2'
stage1_epochs = 0
max_epochs = stage1_epochs+15
test_set = 'benign'  # benign or poisoned
...
optim_wrapper = dict(
    ...
    stage2=dict(type='OptimWrapper', 
                       optimizer=dict(
                           ...
                           lr=0.00001, 
                           weight_decay=0.05),
                        modules = ['trigger', 'neck', 'bbox_head'],
                       clip_grad=dict(max_norm=0.1, norm_type=2),
                       ),
