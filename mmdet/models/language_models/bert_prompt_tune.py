...
try:
    ...
    from mmdet.models.language_models.modeling_bert_prompt_tune import BertModelPT as HFBertModel
except ImportError:
    AutoTokenizer = None
    HFBertModel = None
...
class BertModelPT(BaseModel):
    ...
    def forward(self, captions: Sequence[str], ctx=None, name_lens=None, prompt_type=None, **kwargs) -> dict:
        """Forward function."""
