...
# prompting options
prompt_method = 'cocoop'  # options: coop_new_class, coop_csc, cocoop, ...
n_ctx = 4

seed=42
randomness = dict(seed=seed)
work_dir = f'work_dirs_glip/seed_{seed}/{dataset_name}/{prompt_method}_benign_temp'

# no changes in model, you can directly use the one from the base config
model = dict(
    type='GLIP',
    # prompt related
